                            ...
                            <ul class="uiform-list-fields">
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-wizardbtn" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Wizard btns','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span>
                                    </a>
                            ...
                            <ul class="uiform-list-fields">
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-dcheckbox" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('DynCheckbox','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span>
                                    </a>
                                ...
                                <li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-dradiobutton" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('DynRadioBtn','FRocket_admin'); ?> <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span>
                                    </a>
...
<li>
                                    <a class="uiform-draggable-field uiform-button1 uiform-panelfld" 
                                       ...
                                       href="javascript:void(0);">
                                       <?php echo __('Panel','FRocket_admin'); ?>  <span class="rkfm-express-lock-wrap"
                       data-toggle="tooltip" data-placement="right" 
                       data-original-title="<?php echo __('feature locked','FRocket_admin'); ?>"
                       ><i class="fa fa-lock"></i></span>
                                    </a>
